...
<div class="site-index">
    ...
    <div class="body-content">
        ...
        <section class="encuestas">
            <img class="encuesta-img recurso-plus-a" src="<?= Yii::$app->request->baseUrl ?>/imgs/recurso-plus.svg">
            <img class="encuesta-img recurso-plus-b" src="<?= Yii::$app->request->baseUrl ?>/imgs/recurso-plus.svg">
            <img class="encuesta-img recurso-plus-c" src="<?= Yii::$app->request->baseUrl ?>/imgs/recurso-plus.svg">
            <div class="container">
